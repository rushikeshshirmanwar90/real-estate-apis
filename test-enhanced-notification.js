...
async function runTests() {
  ...
  // Test 3: Transfer activity
  console.log('\n📋 Test 3: Transfer Activity');
  try {
    const transferActivity = {
      ...mockMaterialActivity,
      _id: 'test_transfer_123',
      activity: 'transferred',
      transferDetails: {
        fromProject: {
          id: 'source_project_123',
          name: 'Source Project'
        },
        toProject: {
          id: 'project_123',
    ...
    const result = await notifyMaterialActivityCreated(transferActivity);
